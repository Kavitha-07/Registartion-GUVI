      ...
      <div class="collapse navbar-collapse justify-content-end">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a href="/php-main/register.php" class="nav-link">
              <i class="material-icons">person_add</i>
              Register
            </a>
          </li>
          <li class="nav-item">
            <a href="/php-main/login.php" class="nav-link">
      ...
      <footer class="footer">
        <div class="container">
          <div class="copyright float-right">
            ...
            <a href="https://www.registration.com" target="_blank">Creative Tim</a> 
          </div>
        </div>
      </footer>
    </div>
